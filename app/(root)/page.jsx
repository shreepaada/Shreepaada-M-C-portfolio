...
simple, accessible, and meaningful.
			...
			<Section>
	<div className="mx-auto w-[82%] max-w-screen-2xl min-h-screen flex items-center">
		<div className="max-w-4xl">
			...
			<motion.p
				...
				focusing on user research, interaction design, and
	...
	<div className="mx-auto w-[82%] max-w-screen-2xl min-h-screen flex items-center">
		<div className="max-w-4xl">
			...
			<motion.p
				...
				Explore my UX case studies and projects, including
				<span>
					{" "}
					LifeLink, Fam Manager, and AgroVision.
				</span>
			</motion.p>
			...
			<Section>
	<div className="mx-auto w-[82%] max-w-screen-2xl min-h-screen flex items-center">
		<div className="flex flex-col justify-center items-start text-start max-w-3xl">
			<motion.h1
			...
			<div className="flex flex-wrap items-center gap-4">
				<motion.a
					href="mailto:shreepaadamc2003@gmail.com?subject=Hello"
