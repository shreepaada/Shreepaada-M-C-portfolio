...
const experiences = [
	{
		...
		startDate: "Jan 2025",
		endDate: "Jul 2025",
		company: "Klart'Digi (Klartopedia ERP)",
		position: "UX Design Intern",
		type: "Internship",
		location: "Remote",
		description:
			"Worked on improving the user experience of an ERP platform used by schools. Designed reusable UI components, collaborated closely with developers during implementation, and contributed to certificate and report generation features. Identified usability issues and proposed improvements to create a smoother and more efficient user experience.",
		skills: [
			"Figma",
			"UX Design",
			"Wireframing",
